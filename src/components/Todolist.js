    ...
    <img
      ...
      <div className="z-30 flex flex-col max-w-lg absolute">
        <div className="flex border-4 bg-black border-white flex-col p-4 gap-5">
          <h1 className="text-white flex font-black align-middle justify-center p-1 bg-black border-white border-4 uppercase text-5xl">Type anything you need to do ! If you want to (lol) </h1>
          <div className="flex flex-col justify-center items-center gap-3">
            <input value={newTask} className="w-full min-h-full h-10 text-black p-4 uppercase font-semibold"onChange={(e) => setNewTask(e.target.value)} />
